    ...
    <div class="vip container">
        <div class="row">
            ...
            <div class="col-6 justify-content-end">
                <div class="afficheEvent d-flex  flex-column align-items-center justify-content-center text-light">
                    <h2 class="text-light">TIME REMAINING</h2>
                    <div class="timer">Timer</div>
                    <h1 class="text-white">Titre</h1>
                    <p class="w-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure doloremque, quis non aliquid eius sed architecto neque magni est quam repellat consequatur voluptates. Pariatur eaque perferendis porro vel eum atque.</p>
                </div>
            </div>
        </div>
    </div>
